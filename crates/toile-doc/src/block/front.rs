...
use crate::{Doc, MeasureSet, Piece, Point, PointKey, Variable, Winding};
...
/// The eases and the widths the front is drafted on.
pub(super) const VARIABLES: [(&str, &str); 5] = [
    ("holgura_cadera", "1"),
    ("ancho_rodilla", "24"),
    ("ancho_bajo", "22"),
...
pub(super) const NODES: [(&str, &str, &str); 9] = [
    ("cintura_cf", "0", "0"),
